...
col=(col+colspan)%_this43._columnCount;if("vaadin-form-item"===child.localName){if(_this43._labelsOnTop){child.setAttribute("label-position","top")}else{child.removeAttribute("label-position")}}})}}],[{key:"template",get:function get(){return html(_templateObject5_7871bcd0bea211e9beeacf719d3843c4())}},{key:"is",get:function get(){return"vaadin-form-layout"}},{key:"version",get:function get(){return"2.1.5"}},{key:"properties",get:function get(){return{/**
...
VaadinGridStyles.appendChild(html(_templateObject8_7871bcd0bea211e9beeacf719d3843c4()));var safari=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),firefox=-1<navigator.userAgent.toLowerCase().indexOf("firefox");if(safari||firefox){var scrollingStyles=document.createElement("style");scrollingStyles.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n  ";VaadinGridStyles.querySelector("template").content.appendChild(scrollingStyles)}VaadinGridStyles.register("vaadin-grid-styles");/**
                                                 @license
                                                 Copyright (c) 2018 Vaadin Ltd.
                                                 This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
                                                 */ /**
     ...
     */},{key:"generateCellClassNames",value:function generateCellClassNames(){var _this108=this;Array.from(this.$.items.children).filter(function(row){return!row.hidden}).forEach(function(row){return _this108._generateCellClassNames(row,_this108.__getRowModel(row))})}},{key:"_generateCellClassNames",value:function _generateCellClassNames(row,rowData){var _this109=this;Array.from(row.children).forEach(function(cell){if(cell.__generatedClasses){cell.__generatedClasses.forEach(function(className){return cell.classList.remove(className)})}if(_this109.cellClassNameGenerator){var result=_this109.cellClassNameGenerator(cell._column,rowData);cell.__generatedClasses=result&&result.split(" ").filter(function(className){return 0<className.length});if(cell.__generatedClasses){cell.__generatedClasses.forEach(function(className){return cell.classList.add(className)})}}})}}],[{key:"properties",get:function get(){return{/**
       ...
       *   - `rowData.level` Level of the tree represented with a horizontal offset of the toggle button.
       *   - `rowData.selected` Selected state.
       */cellClassNameGenerator:Function}}},{key:"observers",get:function get(){return["__cellClassNameGeneratorChanged(cellClassNameGenerator)"]}}]);return StylingMixin}(superClass))};_exports.StylingMixin=StylingMixin;var vaadinGridStylingMixin={StylingMixin:StylingMixin};_exports.$vaadinGridStylingMixin=vaadinGridStylingMixin;var TOUCH_DEVICE=function(){try{document.createEvent("TouchEvent");return!0}catch(e){return!1}}(),GridElement=/*#__PURE__*/function(_ElementMixin$4){babelHelpers.inherits(GridElement,_ElementMixin$4);babelHelpers.createClass(GridElement,null,[{key:"template",get:function get(){return html(_templateObject9_7871bcd0bea211e9beeacf719d3843c4())}},{key:"is",get:function get(){return"vaadin-grid"}},{key:"version",get:function get(){return"5.4.7"}},{key:"observers",get:function get(){return["_columnTreeChanged(_columnTree, _columnTree.*)"]}},{key:"properties",get:function get(){return{_this:{type:Object,value:function value(){return this}},_safari:{type:Boolean,value:/^((?!chrome|android).)*safari/i.test(navigator.userAgent)},_ios:{type:Boolean,value:/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream},_edge:{type:Boolean,value:"undefined"!==typeof CSS&&CSS.supports("(-ms-ime-align:auto)")},_ie:{type:Boolean,value:!!(navigator.userAgent.match(/Trident/)&&!navigator.userAgent.match(/MSIE/))},_firefox:{type:Boolean,value:-1<navigator.userAgent.toLowerCase().indexOf("firefox")},_android:{type:Boolean,value:/android/i.test(navigator.userAgent)},_touchDevice:{type:Boolean,value:TOUCH_DEVICE},/**
...
// this.set('selectedRecordData', this.get(`recordDatas.${recordIndex}`))
}},{key:"onRemoveRoom",value:function onRemoveRoom(evt){console.log(evt);var recordIndex=RecordData.findIndex(this.recordDatas,"roomId",evt.detail.value);this.splice("recordDatas",recordIndex,1);this.set("selectedRecordData",{})}},{key:"clearAndSet",value:function clearAndSet(path,value){this.set(path,value);var hostPath=path.split(".")[0],oldVar=this.get(hostPath);this.set(hostPath,{});this.set(hostPath,oldVar)}},{key:"onChanged",value:function onChanged(){console.log(this.selectedRecordData)}}],[{key:"template",get:function get(){return html(_templateObject20_7871bcd0bea211e9beeacf719d3843c4())}},{key:"properties",get:function get(){return{recordDatas:Array,selectedRecordData:Object}}},{key:"observers",get:function get(){return["onChanged(recordDatas.*, selectedRecordData)"]}}]);return BililiveRecorderApp}(PolymerElement);window.customElements.define("bililive-recorder-app",BililiveRecorderApp)});