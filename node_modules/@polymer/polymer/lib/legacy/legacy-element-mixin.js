 ...
 */const LegacyElementMixin=(0,_mixin.dedupingMixin)(base=>{/**
   ...
   * @extends {HTMLElement}
   * @private
   */const legacyElementBase=(0,_dirMixin.DirMixin)((0,_gestureEventListeners.GestureEventListeners)((0,_elementMixin.ElementMixin)(base))),DIRECTION_MAP={x:"pan-x",y:"pan-y",none:"none",all:"auto"};/**
