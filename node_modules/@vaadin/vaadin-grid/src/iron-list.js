define(["exports","../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/iron-resizable-behavior/iron-resizable-behavior.js","../../../@polymer/iron-scroll-target-behavior/iron-scroll-target-behavior.js","../../../@polymer/polymer/lib/utils/async.js","../../../@polymer/polymer/lib/legacy/class.js","../../../@polymer/polymer/lib/utils/flush.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","../../../@polymer/polymer/lib/utils/debounce.js"],function(_exports,_polymerLegacy,_ironResizableBehavior,_ironScrollTargetBehavior,_async,_class,_flush,_polymerDom,_debounce){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PolymerIronList=void 0;/**
@license
...
if(forceUpdate||Math.abs(this._estScrollHeight-this._scrollHeight)>=this._viewportHeight){this.$.items.style.height=this._estScrollHeight+"px";this._scrollHeight=this._estScrollHeight}},/**
   ...
   */scrollToIndex:function(idx){if("number"!==typeof idx||0>idx||idx>this.items.length-1){return}_flush.flush?(0,_flush.flush)():(0,_polymerDom.flush)();// Items should have been rendered prior scrolling to an index.
...
this._itemsPerRow=this._itemsPerRow||1;return this.grid?Math.ceil(idx/this._itemsPerRow)*this._itemsPerRow:idx},_isIndexRendered:function(idx){return idx>=this._virtualStart&&idx<=this._virtualEnd},_getPhysicalIndex:function(vidx){return(this._physicalStart+(vidx-this._virtualStart))%this._physicalCount},_clamp:function(v,min,max){return Math.min(max,Math.max(min,v))},_debounce:function(name,cb,asyncModule){this._debouncers=this._debouncers||{};this._debouncers[name]=_debounce.Debouncer.debounce(this._debouncers[name],asyncModule,cb.bind(this));(0,_flush.enqueueDebouncer)(this._debouncers[name])}});_exports.PolymerIronList=PolymerIronList});